package com.example.JasperReport.controllers;
...
import com.example.JasperReport.services.ReportOrchestrator;
...
class ReportControllerTest {
    ...
    private static com.example.JasperReport.dtos.QueryParamDTO createQuery(String param, String query) {
        var q = new com.example.JasperReport.dtos.QueryParamDTO();
        q.setParam(param);
        q.setQuery(query);
        return q;
    }
